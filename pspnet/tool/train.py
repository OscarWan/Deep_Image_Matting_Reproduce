...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/portrait/portrait_pspnet101.yaml', help='config file')
    parser.add_argument('opts', help='see config/portrait/portrait_pspnet101.yaml for all options', default=None, nargs=argparse.REMAINDER)
...
def train(train_loader, model, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        print("The range of target of the model is:", torch.min(target), torch.max(target))
        print("The range of input of the model is:", torch.min(input), torch.max(input))
